...
public class TestcontainersConfiguration {
	...
	CommandLineRunner testcontainersConfiguration(UserRepository repository) {
		return args -> {
			...
			log.info("Preloading " + repository.save(new User("test3UserNameJournal", "test3FirstNameJournal", "test3LastNameJournal")));
			log.info("Preloading " + repository.save(new User("test4UserNameJournal", "test4FirstNameJournal", "test4LastNameJournal")));
		};
	}
}